# Quality Report — recording_011 (lucas 2)
...
| 5 | 5 | squat | 30.8 | 8 | 8 |  |
| 6 | 6 | squat | 35.4 | 8 | 8 |  |
| 7 | 7 | benchpress | 26.9 | 8 | 8 |  |
| 8 | 8 | benchpress | 23.1 | 8 | 8 |  |
| 9 | 9 | benchpress | 28.2 | 8 | 8 |  |
| 10 | 10 | deadlift | 47.7 | 8 | 8 |  |
| 11 | 11 | deadlift | 46.2 | 8 | 8 |  |
| 12 | 12 | deadlift | 49.1 | 8 | 8 |  |
...
- EDA (`eda_status`): **UNUSABLE** (std=5.286e-09 S, range=1.019e-07 S — sensor floor; threshold: std<1e-7 S OR range<5e-8 S; Greco et al. 2016). EDA column set to all-NaN in parquet.
- EMG/EDA baseline window: 130.8 s before first set
