# Quality Report — recording_014 (Raghild)
...
|---|---|---|---|---|---|---|
| 1 | 1 | pullup | 28.5 | 8 | 8 |  |
| 2 | 2 | pullup | 28.7 | 11 | 11 |  |
| 3 | 3 | pullup | 27.0 | 6 | 6 |  |
| 4 | 4 | squat | 37.8 | 10 | 10 |  |
| 5 | 5 | squat | 31.3 | 9 | 9 |  |
| 6 | 6 | squat | 35.2 | 10 | 10 |  |
| 7 | 7 | deadlift | 30.8 | 8 | ACC |  |
| 8 | 8 | deadlift | 46.9 | 14 | 14 |  REP_COUNT_UNUSUAL(14) |
| 9 | 9 | deadlift | 35.5 | 10 | 10 |  |
| 10 | 10 | benchpress | 25.0 | 10 | 10 |  |
| 11 | 11 | benchpress | 28.3 | 8 | 8 |  |
| 12 | 12 | benchpress | 22.9 | 5 | 5 |  REP_COUNT_UNUSUAL(5) |
...
| 8 | 8 | True | 982 | 0.0% |
| 9 | 9 | True | 741 | 0.0% |
| 10 | 10 | True | 2505 | 100.0% |
| 11 | 11 | True | 2829 | 100.0% |
| 12 | 12 | True | 2293 | 100.0% |

## Modality status
- temperature.csv: present
- EDA (`eda_status`): **UNUSABLE** (std=5.448e-09 S, range=5.035e-08 S — sensor floor; threshold: std<1e-7 S OR range<5e-8 S; Greco et al. 2016). EDA column set to all-NaN in parquet.
- EMG/EDA baseline window: 160.3 s before first set
